...
<div class="container">
	<div class="row">
		<div class="col-md-9">
			<ul class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span> Hanfu News </a></li>
			...
			$sql = mysqli_query($conn, "select *  from news order by addtime desc limit $rsStart, $pageSize");
			while($row=mysqli_fetch_array($sql))
			{
			?>
				<div class="list-group-item">
					<h4><a href="newsshow.php?id=<?=$row['id']?>"><?=$row['title']?> 
					<span class="badge"> <?=$row['addtime']?></span></a></a></h4>
				</div>
