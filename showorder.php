      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <table class="table table-bordered">
            <caption>
              <?php echo $_SESSION['username']; ?>, your order number is: <font color="#FF0000">
                <?php echo $dingdanhao; ?>
              </font>! Here are the details:
            </caption>
            <thead>
              <tr bgcolor="#FFEDBF">
            ...
            <tbody>
              ...
              for ($i = 0; $i < count($arraysp) - 1; $i++) {
                if ($arraysp[$i] != "") {
                  ...
                  <tr>
                    <td height="35">
                      <?php echo $info1['mingcheng']; ?>
                    </td>
                    <td height="35">
                      <?php echo $arraysl[$i]; ?>
                    </td>
                    <td height="35">
                      <?php echo $info1['shichangjia']; ?>¥
                    </td>
                    <td height="35">
                      <?php echo $info1['huiyuanjia']; ?>¥
                    </td>
                    <td height="35">
                      <?php echo $arraysl[$i] * $info1['huiyuanjia']; ?>¥
                    </td>
                  </tr>
                  <?php
                }
            ...
            <tbody>
              <tr>
                <td align="center" colspan="5">Total:
                  <?php echo $total; ?>元
                </td>
                </td>
              </tr>
          ...
          <table class="table table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td height="35">
                  <?php echo $info2['shouhuoren']; ?>
                </td>
              </tr>
              <tr>
                <td height="35">Delivery Address</td>
                <td height="35">
                  <?php echo $info2['dizhi']; ?>
                </td>
              </tr>
              <tr>
            ...
            <tbody>
              <tr>
                <td align="center" colspan="5">Creation Time:
                  <?php echo $info2['time']; ?>
                </td>
                </td>
              </tr>
