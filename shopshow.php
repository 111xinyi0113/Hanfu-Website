	...
	<div class="row">
		<div class="col-md-9">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-6"><img class="img-responsive"
							src="<?php echo __BASE__; ?>/upimages/<?php echo $row11["tupian"]; ?>" alt="" /></div>
					<div class="col-md-6">
						<h2>
							<?= $row11['mingcheng'] ?>
						</h2>
			...
			<div class="list-group">
				...
				while ($row = mysqli_fetch_array($sql)) {
					...
					<div class="list-group-item">
						<h4>Commenter: <font color="#FF0000">
								<?php
								$spid = $row['userid'];
								...
								echo $row1->name;
								?>
							</font> Submission Time: <span class="badge">
								<?= $row['addtime'] ?>
							</span></a> </h4>
					</div>
			...
			<form class="form-horizontal" method="post" role="form" name="form1"
				action="?act=add&pid=<?= $id ?>&typeid=<?= $typeid ?>" onSubmit="return check();">
				<div class="form-group">
					<label for="firstname" class="col-sm-2 control-label">Submit Comment</label>
					<div class="col-sm-10">
						<textarea name="content_desc" rows="4" class="form-control"
