...
<div class="main-content">
	<div class="container">
		...
		<h3 class="tittle bottom"><i class="glyphicon glyphicon-globe"></i>Search Result</h3>
		<div class="grid">
			<?php
			error_reporting(0);
			...
			$sql = mysqli_query($conn,"select *  from shangpin where 1=1 $sqlwhere order by huiyuanjia asc limit $rsStart, $pageSize");
			...
			<div class="col-md-4 m-b">
				<a href="shopshow.php?id=<?php echo $row['id'];?>">
                	<figure class="effect-layla">
						...
						<figcaption><h4>Member Price: <?php echo $row['huiyuanjia'];?><span style="text-decoration:line-through">Price: <?php echo $row['shichangjia'];?></span></h4></figcaption>
					</figure>
				</a>
				<div class="m-b-text">
